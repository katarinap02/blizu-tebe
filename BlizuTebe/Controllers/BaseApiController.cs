...
namespace BlizuTebe.Controllers
{
    ...
    {
        protected ActionResult CreateErrorResponse(IEnumerable<IError> errors)
        {
            var code = 500;
        ...
        private static bool ContainsErrorCode(IEnumerable<IError> errors, int code)
        {
            return errors.Any(e =>
            {
        ...
        private ObjectResult CreateErrorObject(IEnumerable<IError> errors, int code)
        {
